      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="bg-gradient-to-br from-gray-200 to-gray-300 dark:from-slate-700 dark:to-slate-600 rounded-2xl p-8 work-illustration">
          ...
          <div className="relative order-1 lg:order-2">
            <div className="absolute right-8 top-0 bottom-0 w-1 bg-gradient-to-b from-orange-400 via-orange-500 to-orange-600"></div>
            
            {experience.map((item, index) => (
              <div key={index} className="relative flex items-start mb-12 last:mb-0">
                <div className="mr-20 bg-white dark:bg-slate-900/50 backdrop-blur-sm p-6 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-900/70 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl dark:shadow-none dark:hover:shadow-2xl dark:hover:shadow-orange-500/20 flex-1 text-right">
                  <div className="flex items-center justify-end gap-3 mb-3">
                    <div>
                      ...
                      <div className="flex items-center justify-end gap-1 text-gray-500 dark:text-gray-400 text-sm mt-1">
                ...
                <div className="absolute right-4 w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white font-bold border-4 border-gray-50 dark:border-slate-800">
                  {index + 1}
                </div>
              </div>
            ))}
