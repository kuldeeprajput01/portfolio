...
const Certificates: React.FC = () => {
  ...
  const certificates: Certificate[] = [
    ...
    },
    {
      ...
      description: 'Advanced Java programming and enterprise application development',
    ...
    },
    {
      ...
      description: 'Cloud computing expertise and Google Cloud Platform services',
          ...
          {showModal && selectedCert && (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
              <div className="bg-slate-800 rounded-2xl p-8 max-w-2xl w-full relative">
                ...
                <div className="text-center">
                  <div className={`w-32 h-32 mx-auto mb-6 bg-gradient-to-br ${selectedCert.color} rounded-full flex items-center justify-center`}>
                    <Award size={64} className="text-white" />
                  </div>
                  ...
                  <div className="flex justify-center space-x-4">
                    <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 flex items-center gap-2">
